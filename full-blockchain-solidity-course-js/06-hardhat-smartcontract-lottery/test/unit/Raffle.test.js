...
!developmentChains.includes(network.name)
  ...
  : describe("Raffle Unit Tests", function () {
      ...
      beforeEach(async () => {
        ...
        //console.log(`raffleEntranceFee type: ${typeof raffleEntranceFee}, raffleEntranceFee: ${raffleEntranceFee}`);
      ...
      describe("fulfillRandomWords", function () {
        ...
        it("picks a winner, resets, and sends money", async () => {
          const additionalEntrances = BigInt(3); // to test
          const startingIndex = BigInt(2);
          let startingBalance;
          for (
            let i = startingIndex;
